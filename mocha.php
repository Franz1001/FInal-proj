    ...
    <nav>
      ...
      <section class="product">
          <div class="product-content">
              <img src="https://github.com/Franz1001/Image/blob/main/SOle.png?raw=true" alt="Product 2">
              <div class="product-info">
                  <h2 class="product-title"></h2>
                  <p>Jordan 1 Low Reverse Mocha</p>
                  <p>Price: ₱80,000</p>
        ...
        <script>
          ...
          function addToCart() {
            ...
            var productName = "Jordan 1 Low Reverse Mocha";
            var price = 80000;
            var selectedSize = document.getElementById("product1-size").value;
            ...
            // Check if the cart data is already in the session storage
            var cart = JSON.parse(sessionStorage.getItem("cart")) || [];

            // Add the selected product to the cart
            cart.push(product);

            // Save the updated cart data back to session storage
            ...
            window.location.href = "adcart.php";
          }
                  </script>
